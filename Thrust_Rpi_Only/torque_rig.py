...
KT_DEFAULT = 0.88
LEVER_ARM_M = 0.23  # 23 cm from pivot to load cell

LOAD_CELL_PINS = [(12,13), (20,21), (6,5), (23,24)]
OFFSETS = [-152333.5, -2636403.0, -826961.0, 3403535.0]
LABELS = ["Torque_0Deg", "Torque_90Deg", "Torque_180Deg", "Torque_270Deg"]
...
def curses_main(stdscr):
    ...
    while running.is_set():
        ...
        # HEADER
        title = " ideaForge Torque Rig Monitoring System "
        ...
        safe_addstr(stdscr, 11, 6, "─" * 40)
        safe_addstr(stdscr, 12, 6, f"TOTAL WEIGHT : {total_kg:8.3f} kg", curses.A_BOLD)
        safe_addstr(stdscr, 13, 6, f"MECH TORQUE  : {torque_nm:8.3f} Nm", curses.A_BOLD | curses.color_pair(2))
        ...
        footer = "ideaForge Internal • Torque Rig v1 • Lever Arm 23cm • HX711 ×4"
...
# === MAIN ===
def main():
    print("Starting ideaForge Torque Rig Monitoring System...")
    ...
    try:
        ...
        clear_can_buffer()
        close_can()
        print("\nideaForge Torque Rig Monitor stopped cleanly.")
