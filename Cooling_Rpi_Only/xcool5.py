...
# ---- Pressure sensor thread using ADS1115 ----
        ...
        while True:
            with i2c_lock:
                ...
                for chan in channels:
                    ...
                    results.append(bar)
            with data_lock:
                pressure_bars[0], pressure_bars[1] = results
            time.sleep(0.1)
...
def main():
    ...
    with open(filename, 'w', newline='') as f:
        ...
        writer.writerow(["Timestamp", "Pressure1_Bar", "Flow1_Lpm", "Temp1_C",
                         "Pressure2_Bar", "Flow2_Lpm", "Temp2_C", "X_g", "Y_g", "Z_g"])
    ...
    with open(filename, 'a', newline='') as f:
        ...
        try:
            while True:
                ...
                # Log at 50Hz
                writer.writerow([ts, p1, f1, t1, p2, f2, t2, x, y, z])
                f.flush()
                # Print at 1Hz
